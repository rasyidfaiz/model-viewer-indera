...
function ModelViewer2() {
  return (
    <>
      <h1 className="text-center font-sans text-2xl font-bold">3D Viewer</h1>
      <model-viewer
        className="box"
      ...
      >
        <button
          className="rounded-lg border border-slate-200 bg-green-500 px-4 py-2 font-bold text-white hover:bg-green-700"
          class="Hotspot"
          slot="hotspot-1"
